                                            ...
                                            <div class=" d-flex align-items-center justify-content-between ">
                                                ...
                                                <nav>
                                                    <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                                                        ...
                                                        <li class="dropdown-list">
                                                            <router-link to="/product"><span>Product </span>
                                                            </router-link>
                                                        </li>
                                                    </ul>
                                                </nav>
                                                ...
                                                <div class="right d-flex align-items-center justify-content-end">
                                                    <ul class="main-menu__widge-box d-flex align-items-center ">
                                                        <li class="d-lg-block d-none"><a href=""><i
                                                        ...
                                                        <li class="cartm"><a href="#0" class="number cart-icon"> <i
                                                            ...
                                                            class="count">({{cartProducts.length}})</span> </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="side-cart d-flex flex-column justify-content-between">
                <div class="top">
                    <div class="content d-flex justify-content-between align-items-center">
                        <h6 class="text-uppercase">Your Cart ({{cartProducts.length}})</h6>
                    ...
                    <div class="cart_items">
                        ...
                        <div v-for="cartProduct in cartProducts" class="items d-flex justify-content-between align-items-center">
                            <div class="left d-flex align-items-center">
                                <a href="" class="thumb d-flex justify-content-between align-items-center">
                                <img :src="cartProduct.image_url" alt="">
                                </a>
                                <div class="text">
                                    <router-link :to="{name: 'products.show', params: {id: cartProduct.id}}">
                                    <h6>{{ cartProduct.model}}</h6>
                                    </router-link>
                                    <p>{{cartProduct.qty}} X <span>${{cartProduct.price}}</span></p>
                                </div>
                            </div>
                            <div class="right">
                                <div @click.prevent="removeProduct(cartProduct.id)" class="item-remove">
                ...
                <div class="bottom">
                    <div class="total-ammount d-flex justify-content-between align-items-center">
                        ...
                        <h6 class="ammount text-uppercase">${{cartTotalAmount}}</h6>
                    </div>
                    <div class="button-box d-flex justify-content-between">
                        <router-link to="/cart" class="btn_black"> View Cart</router-link>
                        <router-link to="/cart" class="button-2 btn_theme"> Chekout </router-link>
                    </div>
                </div>
            </div>
        </header>
